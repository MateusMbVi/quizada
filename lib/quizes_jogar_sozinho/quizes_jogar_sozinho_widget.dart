...
import 'quizes_jogar_sozinho_model.dart';
export 'quizes_jogar_sozinho_model.dart';

class QuizesJogarSozinhoWidget extends StatefulWidget {
  const QuizesJogarSozinhoWidget({
    super.key,
    this.nomeQuiz,
  });

  final String? nomeQuiz;

  @override
  State<QuizesJogarSozinhoWidget> createState() =>
      _QuizesJogarSozinhoWidgetState();
}

class _QuizesJogarSozinhoWidgetState extends State<QuizesJogarSozinhoWidget> {
  late QuizesJogarSozinhoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizesJogarSozinhoModel());
  }
                                                                  ...
                                                                  children: List.generate(
                                                                    ...
                                                                    return Padding(
                                                                      ...
                                                                      child: StreamBuilder<
                                                                          UserRecord>(
                                                                        stream:
                                                                            UserRecord.getDocument(participantesQuizItem),
                                                                        builder:
                                                                            (context,
                                                                                snapshot) {
                                                                          // Customize what your widget looks like when it's loading.
