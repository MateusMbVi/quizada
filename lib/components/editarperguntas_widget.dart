...
import 'editarperguntas_model.dart';
export 'editarperguntas_model.dart';

class EditarperguntasWidget extends StatefulWidget {
  const EditarperguntasWidget({
    super.key,
    required this.importandoperguntas,
    required this.editarperguntas,
  });

  final DocumentReference? importandoperguntas;
  final DocumentReference? editarperguntas;

  @override
  State<EditarperguntasWidget> createState() => _EditarperguntasWidgetState();
}

class _EditarperguntasWidgetState extends State<EditarperguntasWidget> {
  late EditarperguntasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => EditarperguntasModel());
            ...
            return Container(
              ...
              child: Padding(
                ...
                child: StreamBuilder<PerguntasRecord>(
                  stream: PerguntasRecord.getDocument(widget.editarperguntas!),
                  builder: (context, snapshot) {
                    // Customize what your widget looks like when it's loading.
                    if (!snapshot.hasData) {
                      return Center(
                    ...
                    final columnPerguntasRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.perguntaController ??=
                                  ...
                                  text: columnPerguntasRecord.textoPergunta,
                                ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.alternativaAController ??=
                                    TextEditingController(
                                  text: columnPerguntasRecord.alternativaA,
                                ),
                                ...
                                maxLines: null,
                                validator: _model
                                    .alternativaAControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.alternativaBController ??=
                                    TextEditingController(
                                  text: columnPerguntasRecord.alternativaB,
                                ),
                                ...
                                maxLines: null,
                                validator: _model
                                    .alternativaBControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.alternativaCController ??=
                                    TextEditingController(
                                  text: columnPerguntasRecord.alternativaC,
                                ),
                                ...
                                maxLines: null,
                                validator: _model
                                    .alternativaCControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.alternativaDController ??=
                                    TextEditingController(
                                  text: columnPerguntasRecord.alternativaD,
                                ),
                                ...
                                maxLines: null,
                                validator: _model
                                    .alternativaDControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.alternativaEController ??=
                                    TextEditingController(
                                  text: columnPerguntasRecord.alternativaE,
                                ),
                                ...
                                maxLines: null,
                                validator: _model
                                    .alternativaEControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                            ...
                            child: Container(
                              ...
                              child: TextFormField(
                                controller: _model.alternativaFController ??=
                                    TextEditingController(
                                  text: columnPerguntasRecord.alternativaF,
                                ),
                                ...
                                maxLines: null,
                                validator: _model
                                    .alternativaFControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                          Padding(
                            ...
                            child: FlutterFlowDropDown<String>(
                              controller:
                                ...
                                _model.dropRespostaCorretaValue ??=
                                ...
                                Expanded(
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      ...
                                      await columnPerguntasRecord.reference
                                          .update(createPerguntasRecordData(
                                        textoPergunta:
                                                ...
                                                builder: (alertDialogContext) {
                                                  return AlertDialog(
                                                    title: Text(
                                                        'Excluir questão?'),
                                                    content: Text(
                                                        'Esta ação é irreverssível, deseja mesmo continuar?'),
                                                    actions: [
                                                      TextButton(
                                                        onPressed: () =>
                                                            Navigator.pop(
