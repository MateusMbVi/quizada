...
import 'perguntas_quiz_jogar_sozinho_model.dart';
export 'perguntas_quiz_jogar_sozinho_model.dart';

class PerguntasQuizJogarSozinhoWidget extends StatefulWidget {
  const PerguntasQuizJogarSozinhoWidget({
    super.key,
    this.perguntasQuiz,
    this.identificacao,
  });
  ...
  @override
  State<PerguntasQuizJogarSozinhoWidget> createState() =>
      _PerguntasQuizJogarSozinhoWidgetState();
}

class _PerguntasQuizJogarSozinhoWidgetState
    extends State<PerguntasQuizJogarSozinhoWidget> {
  late PerguntasQuizJogarSozinhoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PerguntasQuizJogarSozinhoModel());
  }
