...
import 'detalhes_quiz_model.dart';
export 'detalhes_quiz_model.dart';

class DetalhesQuizWidget extends StatefulWidget {
  const DetalhesQuizWidget({
    super.key,
    this.detalhesQuiz,
  });
  ...
  @override
  State<DetalhesQuizWidget> createState() => _DetalhesQuizWidgetState();
}

class _DetalhesQuizWidgetState extends State<DetalhesQuizWidget> {
  late DetalhesQuizModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesQuizModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuizRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detalhesQuizQuizRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: Colors.white,
          body: Stack(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                valueOrDefault<String>(
                                  detalhesQuizQuizRecord.imagem != null &&
                                          detalhesQuizQuizRecord.imagem != ''
                                      ? detalhesQuizQuizRecord.imagem
                              ...
                              child: StreamBuilder<List<PerguntasRecord>>(
                                stream: queryPerguntasRecord(
                                  queryBuilder: (perguntasRecord) =>
                                    ...
                                    'quiz',
                                    isEqualTo: detalhesQuizQuizRecord.reference,
                                  ),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      formatNumber(
                                        detalhesQuizQuizRecord.jogadas,
                                        formatType: FormatType.decimal,
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      formatNumber(
                                        detalhesQuizQuizRecord.favoritados,
                                        formatType: FormatType.decimal,
                                        decimalType: DecimalType.commaDecimal,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<UserRecord>(
                        stream: UserRecord.getDocument(
                            detalhesQuizQuizRecord.usuario!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              detalhesQuizQuizRecord.descricao,
                                                              ...
                                                              (respostasRecord) =>
                                                                  respostasRecord
                                                                      .where(
                                                                        'quiz',
                                                                        isEqualTo:
                                                                            detalhesQuizQuizRecord.reference,
                                                                      )
                                                                      .where(
                                                                        'usuario',
                                                                        isEqualTo:
