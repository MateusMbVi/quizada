      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            StreamBuilder<List<PlanosRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                List<PlanosRecord> columnPlanosRecordList = snapshot.data!;
                return SingleChildScrollView(
                  child: Column(
                    mainAxisSize: MainAxisSize.max,
                    children: List.generate(columnPlanosRecordList.length,
                        (columnIndex) {
                      final columnPlanosRecord =
                          columnPlanosRecordList[columnIndex];
                      return Padding(
