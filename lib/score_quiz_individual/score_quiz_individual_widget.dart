...
import 'score_quiz_individual_model.dart';
export 'score_quiz_individual_model.dart';

class ScoreQuizIndividualWidget extends StatefulWidget {
  const ScoreQuizIndividualWidget({
    super.key,
    required this.score,
  });
  ...
  @override
  State<ScoreQuizIndividualWidget> createState() =>
      _ScoreQuizIndividualWidgetState();
}

class _ScoreQuizIndividualWidgetState extends State<ScoreQuizIndividualWidget> {
  late ScoreQuizIndividualModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScoreQuizIndividualModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ScoreRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final scoreQuizIndividualScoreRecord = snapshot.data!;
        return WillPopScope(
            ...
            body: StreamBuilder<List<ScoreRecord>>(
              stream: queryScoreRecord(
                queryBuilder: (scoreRecord) => scoreRecord
                    ...
                    .where(
                      'quiz',
                      isEqualTo: scoreQuizIndividualScoreRecord.quiz,
                    ),
                limit: 1,
              ),
              builder: (context, snapshot) {
                                  ...
                                  child: Card(
                                    ...
                                    child: Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          if (scoreQuizIndividualScoreRecord
                                                  .pontuacao ==
                                              scoreQuizIndividualScoreRecord
                                                  .metaPontos)
                                            Text(
                                              'Parabéns!',
                                              style:
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      '${scoreQuizIndividualScoreRecord.pontuacao.toString()} de ${scoreQuizIndividualScoreRecord.metaPontos.toString()} pontos.',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
                                                                    ...
                                                                    children: List.generate(
                                                                      ...
                                                                      return Padding(
                                                                        ...
                                                                        child: StreamBuilder<
                                                                            PerguntasRecord>(
                                                                          stream:
                                                                              PerguntasRecord.getDocument(columnRespostasRecord.pergunta!),
                                                                          builder:
                                                                              (context, snapshot) {
                                                                            // Customize what your widget looks like when it's loading.
                                                                            if (!snapshot.hasData) {
