...
import 'meus_rankings_publicos_model.dart';
export 'meus_rankings_publicos_model.dart';

class MeusRankingsPublicosWidget extends StatefulWidget {
  const MeusRankingsPublicosWidget({super.key});

  @override
  State<MeusRankingsPublicosWidget> createState() =>
      _MeusRankingsPublicosWidgetState();
}

class _MeusRankingsPublicosWidgetState
    extends State<MeusRankingsPublicosWidget> {
  late MeusRankingsPublicosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MeusRankingsPublicosModel());
  }
            ...
            Padding(
              ...
              child: StreamBuilder<List<RankingRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<RankingRecord> columnRankingRecordList = snapshot.data!;
                  return SingleChildScrollView(
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: List.generate(columnRankingRecordList.length,
                          (columnIndex) {
