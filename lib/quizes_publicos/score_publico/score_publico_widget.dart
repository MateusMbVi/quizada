...
import 'score_publico_model.dart';
export 'score_publico_model.dart';

class ScorePublicoWidget extends StatefulWidget {
  const ScorePublicoWidget({
    super.key,
    required this.score,
  });
  ...
  @override
  State<ScorePublicoWidget> createState() => _ScorePublicoWidgetState();
}

class _ScorePublicoWidgetState extends State<ScorePublicoWidget> {
  late ScorePublicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ScorePublicoModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ScoreRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final scorePublicoScoreRecord = snapshot.data!;
        return WillPopScope(
            ...
            body: StreamBuilder<List<ScoreRecord>>(
              stream: queryScoreRecord(
                queryBuilder: (scoreRecord) => scoreRecord
                    ...
                    .where(
                      'quiz',
                      isEqualTo: scorePublicoScoreRecord.quiz,
                    ),
                limit: 1,
              ),
              builder: (context, snapshot) {
                                  ...
                                  child: Container(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          if (scorePublicoScoreRecord
                                                  .pontuacao ==
                                              scorePublicoScoreRecord
                                                  .metaPontos)
                                            Text(
                                              'Parabéns!',
                                              style:
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Row(
                                                  ...
                                                  children: [
                                                    Text(
                                                      '${scorePublicoScoreRecord.pontuacao.toString()} de ${scorePublicoScoreRecord.metaPontos.toString()} pontos.',
                                                      style: FlutterFlowTheme
                                                              .of(context)
                                                          .bodyMedium
                                                          .override(
