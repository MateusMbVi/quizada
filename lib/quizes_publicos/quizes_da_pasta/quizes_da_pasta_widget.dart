...
import 'quizes_da_pasta_model.dart';
export 'quizes_da_pasta_model.dart';

class QuizesDaPastaWidget extends StatefulWidget {
  const QuizesDaPastaWidget({
    super.key,
    required this.quizesPasta,
  });

  final PastasRecord? quizesPasta;

  @override
  State<QuizesDaPastaWidget> createState() => _QuizesDaPastaWidgetState();
}

class _QuizesDaPastaWidgetState extends State<QuizesDaPastaWidget> {
  late QuizesDaPastaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => QuizesDaPastaModel());
  }
                      ...
                      child: StreamBuilder<List<QuizRecord>>(
                        stream: queryQuizRecord(
                          queryBuilder: (quizRecord) => quizRecord
                              .where(
                                'pasta',
                                isEqualTo: widget.quizesPasta?.reference,
                              )
                              .where(
                                'publico',
                                isEqualTo: true,
