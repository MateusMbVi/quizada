...
import 'detalhes_quiz_publico_model.dart';
export 'detalhes_quiz_publico_model.dart';

class DetalhesQuizPublicoWidget extends StatefulWidget {
  const DetalhesQuizPublicoWidget({
    super.key,
    this.detalhesQuiz,
  });
  ...
  @override
  State<DetalhesQuizPublicoWidget> createState() =>
      _DetalhesQuizPublicoWidgetState();
}

class _DetalhesQuizPublicoWidgetState extends State<DetalhesQuizPublicoWidget> {
  late DetalhesQuizPublicoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetalhesQuizPublicoModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<QuizRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final detalhesQuizPublicoQuizRecord = snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: Colors.white,
          body: Stack(
                            ...
                            child: ClipRRect(
                              ...
                              child: Image.network(
                                valueOrDefault<String>(
                                  detalhesQuizPublicoQuizRecord.imagem !=
                                              null &&
                                          detalhesQuizPublicoQuizRecord
                                                  .imagem !=
                                              ''
                                      ? detalhesQuizPublicoQuizRecord.imagem
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              detalhesQuizPublicoQuizRecord.tema,
                              ...
                              child: StreamBuilder<List<PerguntasRecord>>(
                                stream: queryPerguntasRecord(
                                  queryBuilder: (perguntasRecord) =>
                                    ...
                                    'quiz',
                                    isEqualTo:
                                        detalhesQuizPublicoQuizRecord.reference,
                                  ),
                                ),
                                builder: (context, snapshot) {
                                  // Customize what your widget looks like when it's loading.
                              ...
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Text(
                                      formatNumber(
                                        detalhesQuizPublicoQuizRecord.jogadas,
                                        formatType: FormatType.decimal,
                    ...
                    Padding(
                      ...
                      child: StreamBuilder<UserRecord>(
                        stream: UserRecord.getDocument(
                            detalhesQuizPublicoQuizRecord.usuario!),
                        builder: (context, snapshot) {
                          // Customize what your widget looks like when it's loading.
                          if (!snapshot.hasData) {
                            return Center(
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Text(
                              detalhesQuizPublicoQuizRecord.descricao,
                                                            ...
                                                            onPressed:
                                                              ...
                                                              if (buttonRespostasRecordList
                                                                ...
                                                                if (scoresScoreRecord !=
                                                                  ...
                                                                  await detalhesQuizPublicoQuizRecord
                                                                      .reference
                                                                      .update({
                                                                    ...mapToFirestore(
                                                                      {
                                                                  ...
                                                                  setState(() {
                                                                    FFAppState().perguntaAtual = functions.getValueIndex(
                                                                        ...
                                                                        FFAppState()
                                                                            ...
                                                                            .toList());
                                                                    FFAppState()
                                                                        .addToPerguntasFeitas(
                                                                            FFAppState().perguntaAtual);
                                                                  });

                                                                  context
                                                                      .pushNamed(
                                                                    'perguntasQuizPublico',
                                                                    queryParameters:
                                                                        {
                                                                      'perguntasQuiz':
                                                                          serializeParam(
                                                                  ...
                                                                  var confirmDialogResponse =
                                                                      await showDialog<
                                                                            ...
                                                                            builder:
                                                                                (alertDialogContext) {
                                                                              return AlertDialog(
                                                                                title: Text('Você ainda não terminou\"'),
                                                                                content: Text('Você deseja continuar de onde parou?'),
                                                                                actions: [
                                                                                  TextButton(
                                                                  ...
                                                                  if (confirmDialogResponse) {
                                                                    _model.ultimaPergunta =
                                                                        await actions
                                                                            .retornaUltimaPerguntaRespondida(
                                                                      buttonRespostasRecordList
                                                                          .toList(),
                                                                    );
                                                                    setState(
                                                                    ...
                                                                    setState(
                                                                      ...
                                                                      FFAppState()
                                                                          .addToPerguntasFeitas(
                                                                              FFAppState().perguntaAtual);
                                                                      FFAppState().alternativasAleatorias = pergntasPerguntasRecord!
                                                                          .alternativas
                                                                          .toList()
                                                                          .cast<
                                                                              String>();
